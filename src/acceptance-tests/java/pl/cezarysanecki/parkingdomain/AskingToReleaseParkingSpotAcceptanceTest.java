...
public class AskingToReleaseParkingSpotAcceptanceTest extends BaseAcceptanceTest {
  ...
  @Test
  void currentOccupantShouldBeNotifyToReleaseParkingSpotBecauseThereIsReservation() {
    //given
    ...
    requestingFacade.request(new RequesterId(secondclientId.value()), parkingSpotId, timeSlot, new SpotUnits(4)).get();
    ...
    int result = notifyingAboutReleasingOccupationUseCase.run();
