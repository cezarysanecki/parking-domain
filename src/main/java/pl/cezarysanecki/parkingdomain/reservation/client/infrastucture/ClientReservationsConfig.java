...
public class ClientReservationsConfig {
    ...
    @Bean
    SubmittingReservationRequestForPartOfParkingSpot submittingReservationRequestForPartOfParkingSpot(ClientReservationsRepository clientReservationsRepository) {
        return new SubmittingReservationRequestForPartOfParkingSpot(clientReservationsRepository);
    }
